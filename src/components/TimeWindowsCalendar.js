...
import { format, startOfMonth, endOfMonth, startOfWeek, addDays, isSameDay, isToday, getWeek, isSameMonth } from 'date-fns';
...
const Day = styled.div`
  ...
  border: 1px solid ${(props) =>
    ...
    : 'transparent'};
  background-color: ${(props) => (props.$isSameMonth
    ? (props.$hasWindows ? props.theme.colors.primary : props.theme.colors.background)
    : props.theme.colors.background)};
  color: ${(props) => (props.$isSameMonth
    ? (props.$hasWindows
      ? props.theme.colors.onPrimary
      : props.theme.colors.text)
  ...
  &:hover {
    background-color: ${(props) => (props.$isSameMonth
      ? (props.$hasWindows ? props.theme.colors.primaryHover : props.theme.colors.backgroundHover)
      : props.theme.colors.background)};
  }
